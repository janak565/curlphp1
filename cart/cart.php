 ...
 */
 ...
 class cart{
	...
	public function getProducts(){
		...
		$statement = $dbConnection->prepare("select id, name, price from products order by name asc");
		$statement->execute();
	...
	private function getProductData($id){
		$dbConnection = $this->dbConnection;
		$dbConnection->query( "SET NAMES 'UTF8'" );
		$statement = $dbConnection->prepare("select name, price from products where id = ? limit 1");
